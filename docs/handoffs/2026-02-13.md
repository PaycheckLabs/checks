...
- Created/updated project handoff workflow in-repo.
- Confirmed tooling/config files are now in a good state.
- Confirmed the “Raw view” verification method is the source of truth for newline issues.
