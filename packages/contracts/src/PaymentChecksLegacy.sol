...
/// @title PaymentChecksLegacy
/// @notice DEPRECATED legacy Payment Checks (escrows collateral in the contract).
/// @dev Kept temporarily for history. Use `PaymentChecks` (ERC-6551) for the active build.
contract PaymentChecksLegacy is ERC721, ReentrancyGuard, IPaymentChecks {
