...
contract PaymentChecks is ERC721, ReentrancyGuard {
    ...
    struct PaymentCheck {
        ...
        string memo;    // <= MAX_MEMO_BYTES bytes
        Status status;
    }
    ...
    function mintPaymentCheck(
        ...
        // 1) Create the token-bound account for this NFT.
        ...
        // 2) Fund the TBA directly at mint-time.
